...
<body>
    ...
    <main id="main" data-aos="fade" data-aos-delay="1500">
        ...
        $sql_st = " SELECT * FROM tbl_station WHERE station_id = '4' ";
        ...
        <section style="margin-top: 8rem;">
            <div class="container-fluid px-1 px-md-3 py-0 mx-auto">
                <div class="row d-flex justify-content-start px-4 gx-4">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 mb-3 mx-auto">
                            ...
                            <div class="col-lg-6 col-md-6 mb-3">
                                <div class="mt-3 text-center d-grid">
                                    <button type="button" id="mylocation" class="btn btn-block btn-primary fs-4" style="height: 10rem;"><i class="fas fa-location-arrow"></i> หาตำแหน่งปัจจุบัน</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        async function showWheather(lat, lon) {
            try {
                const response = await axios.get(`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&units=metric&lang=th&appid=<?= $api_keys ?>`);
