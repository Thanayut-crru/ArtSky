...
<body>
    ...
    <main id="main" data-aos="fade" data-aos-delay="350">
        ...
        <section class="pt-4 pt-md-5">
            <div class="col-lg-12 text-center">
                <div class="section-header" data-aos="fade-up">
                    <h1 class="text-light">พื้นที่ท้องฟ้ามืด</h1>
                </div>
            </div>

            <div class="art-skys slider" data-aos="fade-up" data-aos-delay="150">
                <?php
                    ...
                    <div class="slide m-1">
                        <div class="col-lg-10 col-md-10 mx-auto">
                            <div class="card border border-0 bg-skys">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title text-center fkanit mb-2">
                                        <a href="station?id=<?= (int)$rs_st['station_id'] ?>">
                                            <?= htmlspecialchars($rs_st['station_name']) ?>
                                        </a>
                                    </h5>
        ...
        <!-- ======= Hotels ======= -->
        <section class="mt-5 pt-4 pt-md-5">
            <div class="col-lg-12 text-center">
                <div class="section-header" data-aos="fade-up">
                    <h2 class="p-2">ART SKY Place</h2>
                    <p>ที่พักแนะนำสำหรับนอนดูดาวใกล้พื้นที่ท้องฟ้ามืด</p>
                </div>
            </div>

            <div class="art-skys3 slider" data-aos="fade-up" data-aos-delay="150">
                <?php
                    ...
                    <div class="slide m-1">
                        <div class="col-lg-11 col-md-11 mx-auto">
                            <div class="card border border-0 bg-skys">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title text-center fkanit mb-2">
                                        <a href="hotel"><?= htmlspecialchars($rs_hotel1['hotel_name']) ?></a>
                                    </h5>
                                    <p class="card-text text-center mb-0">
                                        <a href="hotel"><?= number_format((float)$rs_hotel1['hotel_price']) ?>฿</a>
                                    </p>
                                </div>
                            </div>
                        </div>
