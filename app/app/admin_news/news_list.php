<div class="card">
    ...
    <div class="card-header">
        <a href="?act=news&pg=news_add" class="btn btn-primary"><i class="fas fa-plus"></i> เพิ่มข้อมูล</a>
    </div>

    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-sm table-striped table-hover text-nowrap" id="table-news">
                <thead>
                    <tr>
...
<script>
    $(document).ready(function() {
        ...
        $('#table-news').dataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "admin_news/news_list_ajax.php",
                "type": "POST"
            },
            // Thai lang
            "oLanguage": {
