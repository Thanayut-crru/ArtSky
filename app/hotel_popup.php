...
<head>
  ...
  <style>
    ...
    .hotel-popup-card {
      ...
      background:
        radial-gradient(circle at top left, rgba(15, 23, 42, 0.3), rgba(15, 23, 42, 0.98));
                      ...
                      if ($num_img > 0) {
                        if ($rs_img['hotel_image_name'] != "") { ?>
                          <div class="swiper-slide">
                            <img src="./images/hotel_image/<?= $rs_img['hotel_image_name'] ?>" alt="<?= $rs['hotel_name'] ?>">
                          </div>
                    <?php }
                      }
                    } ?>
              ...
              <div class="portfolio-info">
                ...
                <ul>
                  ...
                  ?>
                    <li>
                      <strong>
                        <i class="bi bi-cash-coin info-label-icon"></i>
                        เริ่มต้น ราคา/คืน
                      </strong>
                      <span><?= $rs['hotel_price'] ?> ฿</span>
                    </li>
                  <?php } ?>
                  <?php
                  if ($rs['hotel_telephone']) {
                  ?>
                    <li>
                      <strong>
                  ...
                  ?>
                    <li>
                      ...
                      <a href="https://line.me/ti/p/~<?= $rs['hotel_line'] ?>" target="_blank"><?= $rs['hotel_line'] ?></a>
                    </li>
                  <?php } ?>
                  <?php
                  if ($rs['hotel_email']) {
                  ?>
                    <li>
                      ...
                      <a href="mailto:<?= $rs['hotel_email'] ?>" target="_blank"><?= $rs['hotel_email'] ?></a>
                    </li>
                  <?php } ?>
                  <?php
                  if ($rs['hotel_facebook']) {
                  ?>
                    <li>
                      <strong>
                      ...
                      <a href="mailto:<?= $rs['hotel_facebook'] ?>" target="_blank"><?= mb_substr($rs['hotel_facebook'], 0, 30, 'UTF-8'); ?></a>
                    </li>
                  <?php } ?>
                  <?php
                  if ($rs['hotel_website']) {
                  ?>
                    <li>
                      ...
                      <a href="<?= $rs['hotel_website'] ?>" target="_blank">
                        <?= mb_substr($rs['hotel_website'], 0, 30, 'UTF-8'); ?>
                      </a>
                    </li>
                  <?php } ?>
                  <?php
                  ...
                  ?>
                    <li>
                      <a href="tel:<?= $rs['hotel_telephone'] ?>" class="btn-visit align-self-center">
